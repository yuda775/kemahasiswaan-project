...
const mockData = ref([
    ...
    { id: 1, category: 'Olahraga', name: 'Sepak Bola', points: 10, advisorStatus: 'Disetujui', studentAffairsStatus: 'Disetujui', academicYear: '2022/2023 Ganjil', comment: 'Terima kasih atas kesempatan ini.' },
    { id: 2, category: 'Seni', name: 'Lukis', points: 8, advisorStatus: 'Disetujui', studentAffairsStatus: 'Disetujui', academicYear: '2022/2023 Ganjil', comment: 'Saya sangat senang dengan kegiatan ini.' },
    { id: 3, category: 'Musik', name: 'Paduan Suara', points: 9, advisorStatus: 'Ditolak', studentAffairsStatus: 'Disetujui', academicYear: '2022/2023 Ganjil', comment: 'Saya harap kegiatan ini dapat diadakan kembali.' },
    { id: 4, category: 'Komunitas', name: 'Debat', points: 7, advisorStatus: 'Disetujui', studentAffairsStatus: 'Ditolak', academicYear: '2022/2023 Genap', comment: 'Kegiatan ini sangat bermanfaat bagi saya.' },
    { id: 5, category: 'Olahraga', name: 'Bulu Tangkis', points: 11, advisorStatus: 'Disetujui', studentAffairsStatus: 'Menuggu', academicYear: '2022/2023 Genap', comment: 'Saya sangat menikmati kegiatan ini.' },
    { id: 6, category: 'Seni', name: 'Teater', points: 6, advisorStatus: 'Ditolak', studentAffairsStatus: 'Ditolak', academicYear: '2022/2023 Genap', comment: 'Saya harap kegiatan ini dapat diadakan kembali.' },
    { id: 7, category: 'Musik', name: 'Band', points: 12, advisorStatus: 'Disetujui', studentAffairsStatus: 'Disetujui', academicYear: '2023/2024 Ganjil', comment: 'Terima kasih atas kesempatan ini.' }
]);
...
<template>
    <div>
        <div class="card">
            ...
            >
                <template #header>
                    <div class="flex sm:flex-row flex-col gap-2 sm:gap-0 justify-end">
                        <IconField class="sm:w-auto w-full">
                            <InputIcon>
                                <i class="pi pi-search" />
                            </InputIcon>
                            <InputText class="w-full sm:min-w-[25rem]" v-model="filters.global.value" placeholder="Keyword Search" />
                        </IconField>
                    </div>
                </template>
